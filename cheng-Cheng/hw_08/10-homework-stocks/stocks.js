...
function Stocks(symbol, shares ){
  this.symbol = symbol;
  this.shares = shares;
  this.exchange = "NYSE";
  this.buyShares = function(number){
    this.shares += number;
    console.log("You now have "+this.shares+" shares of "+this.symbol+"!")
  };
  this.sellShares = function(number){
    if (this.shares > 0){
      if (this.shares > number){
        ...
        this.shares = 0;
        console.log("You did not have enough shares to sell "+number+
        ". Instead, we have sold all of your shares. You now have 0 shares of "+this.symbol+".")
      }
    } else {
      console.log("You do not have any shares of "+this.symbol+" to sell!")
    }
  };
  this.calcValue = function(){
    var value = this.shares * 50.35;
    console.log("Your holdings of "+this.shares+" shares of "+this.symbol+
    " is worth $" + value.toFixed(2) + "!")
  };
};
